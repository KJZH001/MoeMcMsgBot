...
```text
    这个算是我自学 Java 的第一个成果吧
    
    作者作为一届高中生，没有系统的的课程去学习 Java 语言，
很多东西都是从网上东拼一点，西凑一点。。因此代码这边写的
也是一团糟。。。优化也做得贼差劲。。。但我的确是用心去做
这个了。而且对我来说，这个插件居然也会让一些大佬感兴趣，
这个是我当初没想到的。本以为只是一些对Java语言编程什么都
不懂的普通用户..

    趁着这个暑假，我会去多学一点 Java 的知识，我也希望这个
插件最终会变成当初我想的样子。
...
- #### **加载插件时会报错**
    ...
    - 插件版本于 1.8 及以上： <br/>
    其具体内容为 `java.lang.NullPointerException` <br/>
    
    且使用 `mirai-api-http 2.0`<br/>
